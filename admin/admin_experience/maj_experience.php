...
$id_experience = $_GET['maj_id_experience'];

//Vérification de si l'id est valide
if ($id_experience > 0) {
    //pour récupérer les informations avec l'ID spécifique
    $sql = "SELECT * FROM experience_info WHERE id_experience = $id_experience";
    ...
    die("ID de l'experience incorerect");
}
...
if (isset($_POST['modifier'])) {
    ...
    $sql = "UPDATE experience_info SET 
            ...
            <div class="zone_contenu">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nom_experience" value="<?php echo htmlspecialchars($nom_experience); ?>">
                    </div>

                    <div class="form-group">
                        <label>Date de l'Experience</label>
                        <input type="number" class="form-control" name="date_experience" value="<?php echo htmlspecialchars($date_experience); ?>">
                    </div>

                    <div class="form-group">
                        <label>Description de l'Experience</label>
                        <textarea class="form-control" name="description_experience" rows="4" ><?php echo htmlspecialchars($description_experience); ?></textarea>
                    </div>
